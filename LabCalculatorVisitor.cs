...
namespace LabCalculator
{
    class LabCalculatorVisitor : ExpressionGrammarBaseVisitor<double>
    {
        ...
        public override double VisitIdentifierExpression(ExpressionGrammarParser.IdentifierExpressionContext context)
        {
            ...
            Cell cell = (Cell)dgv.Rows[currentRow].Cells[currentCol];// get cell
            ...
            if (((Cell)(dgv.Rows[currentRow].Cells[currentCol])).Expression.Contains(letters + numbers))
            {
                ...
                ((Cell)(dgv.Rows[numbers].Cells[letters])).Variables.Add(colName + rowName);
            }
            try
            {
                /*if (((letters + numbers.ToString()) != (colName + rowName)) 
                    && !(RecurChecker.Check((Cell)dgv.Rows[numbers].Cells[letters], letters + numbers, new HashSet<string>())) 
                   )
                */
                if (!(RecurChecker.Check((Cell)dgv.Rows[numbers].Cells[letters], letters + numbers, new HashSet<string>())))
                {
                    //     MessageBox.Show("Recur checker OK");
                    //     MessageBox.Show("Expression: " + ((Cell)dgv.Rows[numbers].Cells[letters]).Expression);
                    ...
                    return Convert.ToDouble(Calculator.Evaluate(((Cell)dgv.Rows[numbers].Cells[letters]).Expression));
                }
                else
                {
